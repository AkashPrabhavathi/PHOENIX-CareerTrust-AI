...
const T = {
  en: {
    ...
    logout: 'Logout', heroBadge: '🛡️ SMART CAREER SAFETY', heroLine1: "Don't just detect scams.", heroLine2: 'Make smarter career decisions.',
    heroSub: 'Paste a job or internship offer, upload a screenshot, or type it in — get a full trust report in seconds.',
    statPatterns: 'Scam Patterns Checked', statReports: 'Reports Analyzed', statFree: 'Free to Use', getStarted: "Get Started — It's Free 🚀",
    loginTitle: '🛡️ Login to Continue', loginSub: 'Free — just your name and email', namePh: 'Your Name', emailPh: 'Email Address', phonePh: 'Phone Number (optional)',
    loginBtn: 'Login & Continue →', formTitle: 'Tell us about the opportunity', formSub: 'Add as much detail as you can for the most accurate report.',
    companyLabel: '🏢 Company Name:', screenshotLabel: '📸 Upload a Screenshot (optional):', jobTextLabel: '💬 Job Offer Text:',
    jobTextHint: '📱 Paste message as received, upload a screenshot, or use the mic', skillsLabel: '🧠 Your Skills:', back: '← Back',
    analyzeBtn: '🔍 Analyze Opportunity', newAnalysis: '🔄 New Analysis', download: '⬇️ Download / Print', addCompare: '➕ Add to Comparison',
    shareWA: '📲 Share on WhatsApp', shareMail: '✉️ Share via Email', viewCompare: '📊 View Comparison', historyTitle: '📜 Report History',
    clearAll: 'Clear All', noHistory: 'No past reports yet. Analyze an opportunity to see it here.', view: 'View →',
    aboutTitle: 'About CareerTrust AI', profileTitle: '👤 My Profile', saveProfile: 'Save Profile', reportsCount: 'Reports Analyzed',
    memberSince: 'Member Since', defaultSkillsLabel: 'Default Skills (auto-filled in forms):',
  },
  ta: {
    home: '1. முகப்பு', details: '2. விவரங்கள்', result: '3. முடிவு', history: '4. வரலாறு', about: '5. எங்களைப் பற்றி', profile: '6. சுயவிவரம்',
    logout: 'வெளியேறு', heroBadge: '🛡️ ஸ்மார்ட் கரியர் பாதுகாப்பு', heroLine1: 'ஏமாற்றை கண்டறிவது மட்டும் இல்லை.', heroLine2: 'சிறந்த கரியர் முடிவுகளை எடுங்கள்.',
    heroSub: 'வேலை அல்லது இன்டர்ன்ஷிப் ஆஃபரை பேஸ்ட் செய்யுங்கள், ஸ்கிரீன்ஷாட் பதிவேற்றுங்கள், அல்லது டைப் செய்யுங்கள் — சில நொடிகளில் முழு நம்பிக்கை அறிக்கை பெறுங்கள்.',
    statPatterns: 'ஸ்கேம் பேட்டர்ன்கள் சரிபார்க்கப்பட்டது', statReports: 'பகுப்பாய்வு செய்யப்பட்ட அறிக்கைகள்', statFree: 'இலவசமாக பயன்படுத்தலாம்', getStarted: 'இலவசமாக தொடங்குங்கள் 🚀',
    loginTitle: '🛡️ தொடர உள்நுழையவும்', loginSub: 'இலவசம் — உங்கள் பெயரும் மின்னஞ்சலும் மட்டும்', namePh: 'உங்கள் பெயர்', emailPh: 'மின்னஞ்சல் முகவரி', phonePh: 'தொலைபேசி எண் (விருப்பம்)',
    loginBtn: 'உள்நுழைந்து தொடரவும் →', formTitle: 'வாய்ப்பு பற்றி எங்களிடம் கூறுங்கள்', formSub: 'மிகச் சரியான அறிக்கைக்கு முடிந்தவரை விவரங்களைச் சேர்க்கவும்.',
    companyLabel: '🏢 நிறுவனத்தின் பெயர்:', screenshotLabel: '📸 ஸ்கிரீன்ஷாட் பதிவேற்றவும் (விருப்பம்):', jobTextLabel: '💬 வேலை ஆஃபர் உரை:',
    jobTextHint: '📱 வந்தபடியே செய்தியை பேஸ்ட் செய்யவும், ஸ்கிரீன்ஷாட் பதிவேற்றவும், அல்லது மைக் பயன்படுத்தவும்', skillsLabel: '🧠 உங்கள் திறமைகள்:', back: '← பின் செல்',
    analyzeBtn: '🔍 வாய்ப்பை பகுப்பாய்வு செய்யவும்', newAnalysis: '🔄 புதிய பகுப்பாய்வு', download: '⬇️ பதிவிறக்கு / அச்சிடு', addCompare: '➕ ஒப்பீட்டில் சேர்',
    shareWA: '📲 வாட்ஸ்அப்பில் பகிர்', shareMail: '✉️ மின்னஞ்சல் வழியாக பகிர்', viewCompare: '📊 ஒப்பீட்டைப் பார்க்க', historyTitle: '📜 அறிக்கை வரலாறு',
    clearAll: 'அனைத்தையும் அழி', noHistory: 'இதுவரை அறிக்கைகள் இல்லை. ஒரு வாய்ப்பை பகுப்பாய்வு செய்யவும்.', view: 'பார்க்க →',
    aboutTitle: 'CareerTrust AI பற்றி', profileTitle: '👤 எனது சுயவிவரம்', saveProfile: 'சுயவிவரத்தை சேமிக்கவும்', reportsCount: 'பகுப்பாய்வு செய்யப்பட்ட அறிக்கைகள்',
    memberSince: 'உறுப்பினர் ஆனது', defaultSkillsLabel: 'இயல்புநிலை திறமைகள் (படிவங்களில் தானாக நிரப்பப்படும்):',
  },
}
...
function App() {
  ...
  useEffect(() => {
    ...
    try { setHistoryList(JSON.parse(localStorage.getItem('ct_history') || '[]')) } catch (e) { setHistoryList([]) }
    const savedSkills = localStorage.getItem('ct_default_skills') || ''
    setDefaultSkills(savedSkills)
  }, [])
  ...
  useEffect(() => {
    ...
    if (end === 0) return
    const stepTime = Math.max(Math.floor(900 / end), 8)
    const timer = setInterval(() => {
      start += Math.ceil(end / 60)
      if (start >= end) { setDisplayCount(end); clearInterval(timer) } else setDisplayCount(start)
    }, stepTime)
  ...
  const handleLogout = () => {
    setIsLoggedIn(false); setLoginData({ name: '', email: '', phone: '' }); setJobText(''); setSkills(''); setCompanyName(''); setResult(null); setPage('login')
  }

  const saveProfile = () => {
    localStorage.setItem('ct_default_skills', defaultSkills)
    alert('Profile saved!')
  }
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      setPage('result')
    } catch (error) { setResult({ error: 'Could not connect to backend. Is it running?' }); setPage('result') }
    setLoading(false)
  }

  const viewHistoryEntry = (entry) => { setJobText(entry.jobText); setSkills(entry.skills); setCompanyName(entry.companyName); setResult(entry.result); setPage('result') }
  const clearHistory = () => { setHistoryList([]); localStorage.removeItem('ct_history') }

  const handleScreenshotUpload = async (e) => {
    const file = e.target.files[0]; if (!file) return
    setOcrLoading(true); setOcrProgress(0)
    try {
      const { data } = await Tesseract.recognize(file, 'eng', { logger: (m) => { if (m.status === 'recognizing text') setOcrProgress(Math.round(m.progress * 100)) } })
      setJobText(data.text.trim())
    } catch (error) { alert('Could not read text from this image. Try pasting the text manually.') }
    setOcrLoading(false)
  }
  ...
  const addToComparison = () => {
    ...
    setComparisonList([...comparisonList, { id: Date.now(), companyName: companyName || 'Unnamed Company', risk_score: result.risk_score, risk_level: result.risk_level, opportunity_score: result.opportunity_score, salary_status: result.salary_analysis.status, skill_match_percent: result.skill_match.skill_match_percent, missing_skills: result.skill_match.missing_skills }])
  }
  const removeFromComparison = (id) => setComparisonList(comparisonList.filter((item) => item.id !== id))
  const startNewAnalysis = () => { setJobText(''); setSkills(defaultSkills); setCompanyName(''); setResult(null); setPage('form') }
    ...
    <div style={{ minHeight: '100vh', background: theme.pageBg, fontFamily: 'sans-serif', transition: 'background 0.3s ease', position: 'relative' }}>
      ...
      {page === 'form' && (
        <div key="form" className="page-fade" style={{ maxWidth: '650px', margin: '0 auto', padding: '40px 16px' }}>
          ...
          <div style={{ background: theme.cardBg, borderRadius: '14px', padding: '22px', boxShadow: '0 8px 24px rgba(0,0,0,0.08)' }}>
            ...
            <label style={{ fontWeight: 'bold', color: theme.text }}>{L.jobTextLabel}</label>
            <div style={{ background: darkMode ? '#0f2a25' : '#e9fdf3', borderRadius: '12px', padding: '10px', marginTop: '6px', marginBottom: '14px', border: '1px solid #b6e8d5' }}>
              <div style={{ fontSize: '11px', color: '#02c39a', marginBottom: '4px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span>{L.jobTextHint}</span>
                <button className={listening ? 'mic-btn listening' : 'mic-btn'} onClick={startVoiceInput} style={{ background: listening ? '#c62828' : '#028090', color: '#fff', border: 'none', borderRadius: '50%', width: '28px', height: '28px', cursor: 'pointer', fontSize: '13px' }}>🎤</button>
              </div>
          ...
          {loading && <div style={{ marginTop: '20px' }}><div className="skeleton" style={{ height: '80px', marginBottom: '12px' }}></div><div className="skeleton" style={{ height: '50px', marginBottom: '12px' }}></div><div className="skeleton" style={{ height: '50px' }}></div></div>}
        </div>
      )}
            ...
            <div id="report-area">
              ...
              <div style={{ display: 'flex', gap: '12px', marginBottom: '16px', flexWrap: 'wrap' }}>
                <div style={{ flex: 1, minWidth: '200px', padding: '18px', borderRadius: '12px', background: getRiskColor(result.risk_level), color: '#fff', boxShadow: '0 6px 16px rgba(0,0,0,0.15)' }}>
                  ...
                  <div style={{ background: 'rgba(255,255,255,0.3)', borderRadius: '6px', height: '8px', overflow: 'hidden' }}><div style={{ background: '#fff', height: '100%', width: `${result.risk_score}%`, borderRadius: '6px', transition: 'width 1s ease' }}></div></div>
                </div>
                <div style={{ flex: 1, minWidth: '200px', padding: '18px', borderRadius: '12px', background: 'linear-gradient(135deg, #1565c0, #42a5f5)', color: '#fff', boxShadow: '0 6px 16px rgba(0,0,0,0.15)' }}>
                  ...
                  <div style={{ background: 'rgba(255,255,255,0.3)', borderRadius: '6px', height: '8px', overflow: 'hidden' }}><div style={{ background: '#fff', height: '100%', width: `${result.opportunity_score}%`, borderRadius: '6px', transition: 'width 1s ease' }}></div></div>
                </div>
              </div>
              {result.suggested_companies && result.suggested_companies.length > 0 && (
                <div style={{ background: theme.cardBg, borderRadius: '12px', padding: '16px', marginBottom: '16px', boxShadow: '0 4px 12px rgba(0,0,0,0.06)' }}>
                  ...
                  <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                    {result.suggested_companies.map((c, idx) => (<div key={idx} style={{ background: 'linear-gradient(135deg, #02c39a, #028090)', color: '#fff', borderRadius: '10px', padding: '10px 14px', minWidth: '150px' }}><div style={{ fontWeight: 'bold' }}>{c.company}</div><div style={{ fontSize: '12px' }}>{c.match_percent}% skill match</div><div style={{ fontSize: '11px', opacity: 0.9 }}>{c.matched_skills.join(', ')}</div></div>))}
                  </div>
                </div>
              )}
              ...
              {result.link_check.suspicious_links.length > 0 && (<div style={{ ...cardStyle, borderLeft: '4px solid #ef6c00' }}><strong style={{ color: theme.text }}>⚠️ Suspicious Links Detected</strong><p style={{ margin: '6px 0', color: theme.text }}>{result.link_check.note}</p></div>)}
              <h3 style={{ marginTop: '20px', color: theme.text }}>💰 Salary Analysis</h3>
              <div style={cardStyle}><p style={{ margin: '4px 0', color: theme.text }}><strong>Offered:</strong> {result.salary_analysis.offered_salary ? `₹${result.salary_analysis.offered_salary}` : 'Not mentioned'}</p><p style={{ margin: '4px 0', color: theme.text }}><strong>Typical Range:</strong> {result.salary_analysis.estimated_range}</p><p style={{ margin: '4px 0', color: theme.text }}><strong>Status:</strong> {result.salary_analysis.status}</p><p style={{ margin: '4px 0', color: theme.muted }}>{result.salary_analysis.explanation}</p></div>
              <h3 style={{ marginTop: '20px', color: theme.text }}>🧠 Skill Match</h3>
              <div style={cardStyle}><p style={{ margin: '4px 0', color: theme.text }}><strong>Match:</strong> {result.skill_match.skill_match_percent}%</p><p style={{ margin: '4px 0', color: theme.text }}><strong>Matched Skills:</strong> {result.skill_match.matched_skills.join(', ') || 'None found'}</p><p style={{ margin: '4px 0', color: theme.text }}><strong>Missing Skills:</strong> {result.skill_match.missing_skills.join(', ') || 'None detected'}</p><p style={{ margin: '4px 0', color: theme.muted }}>{result.skill_match.recommendation}</p></div>
              <h3 style={{ marginTop: '20px', color: theme.text }}>✅ Safe Apply Checklist</h3>
              <ul style={{ background: theme.cardBg, color: theme.text, borderRadius: '8px', padding: '16px 30px' }}>{result.safe_apply_checklist.map((item, idx) => <li key={idx} style={{ marginBottom: '6px' }}>{item}</li>)}</ul>
            ...
            <div id="comparison-section" className="no-print" style={{ marginTop: '40px' }}>
              ...
              <div style={{ overflowX: 'auto', background: theme.cardBg, borderRadius: '10px', padding: '10px' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px', color: theme.text }}>
                  <thead><tr style={{ background: '#028090', color: '#fff', textAlign: 'left' }}><th style={{ padding: '8px', border: '1px solid #ddd' }}>Company</th><th style={{ padding: '8px', border: '1px solid #ddd' }}>Risk</th><th style={{ padding: '8px', border: '1px solid #ddd' }}>Opportunity</th><th style={{ padding: '8px', border: '1px solid #ddd' }}>Salary</th><th style={{ padding: '8px', border: '1px solid #ddd' }}>Skill Match</th><th style={{ padding: '8px', border: '1px solid #ddd' }}>Skills to Learn</th><th style={{ padding: '8px', border: '1px solid #ddd' }}>Recommendation</th><th style={{ padding: '8px', border: '1px solid #ddd' }}></th></tr></thead>
                  <tbody>{comparisonList.map((entry) => (<tr key={entry.id}><td style={{ padding: '8px', border: `1px solid ${theme.border}` }}>{entry.companyName}</td><td style={{ padding: '8px', border: `1px solid ${theme.border}`, color: getRiskColor(entry.risk_level) }}>{entry.risk_score}/100 ({entry.risk_level})</td><td style={{ padding: '8px', border: `1px solid ${theme.border}` }}>{entry.opportunity_score}/100</td><td style={{ padding: '8px', border: `1px solid ${theme.border}` }}>{entry.salary_status}</td><td style={{ padding: '8px', border: `1px solid ${theme.border}` }}>{entry.skill_match_percent}%</td><td style={{ padding: '8px', border: `1px solid ${theme.border}` }}>{entry.missing_skills.join(', ') || 'None'}</td><td style={{ padding: '8px', border: `1px solid ${theme.border}` }}>{getRecommendation(entry)}</td><td style={{ padding: '8px', border: `1px solid ${theme.border}` }}><button onClick={() => removeFromComparison(entry.id)} style={{ background: '#c62828', color: '#fff', border: 'none', padding: '4px 8px', borderRadius: '4px', cursor: 'pointer' }}>Remove</button></td></tr>))}</tbody>
                </table>
              </div>
            </div>
          )}
      ...
      {page === 'history' && (
        <div key="history" className="page-fade" style={{ maxWidth: '700px', margin: '0 auto', padding: '40px 16px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
            <h1 style={{ color: theme.text, fontSize: '24px', margin: 0 }}>{L.historyTitle}</h1>
            {historyList.length > 0 && <button onClick={clearHistory} style={{ background: '#c62828', color: '#fff', border: 'none', padding: '8px 14px', borderRadius: '8px', cursor: 'pointer', fontSize: '12px' }}>{L.clearAll}</button>}
          </div>
      ...
      {page === 'about' && (
        <div key="about" className="page-fade" style={{ maxWidth: '700px', margin: '0 auto', padding: '40px 16px 60px' }}>
          <h1 style={{ color: theme.text, fontSize: '28px', textAlign: 'center', marginBottom: '8px' }}>{L.aboutTitle}</h1>
          <p style={{ color: theme.muted, textAlign: 'center', maxWidth: '520px', margin: '0 auto 30px' }}>CareerTrust AI helps students make safer, evidence-based decisions about job and internship offers.</p>
          <div style={{ background: theme.cardBg, borderRadius: '14px', padding: '24px', marginBottom: '24px', boxShadow: '0 4px 14px rgba(0,0,0,0.06)' }}>
            ...
            <p style={{ color: theme.muted, fontSize: '14px' }}>Every year, students lose money and opportunities to fake job offers. This project gives every student a free, transparent first line of defense.</p>
          </div>
      ...
      {page === 'profile' && (
        <div key="profile" className="page-fade" style={{ maxWidth: '550px', margin: '0 auto', padding: '40px 16px 60px' }}>
          <h1 style={{ color: theme.text, fontSize: '26px', textAlign: 'center', marginBottom: '24px' }}>{L.profileTitle}</h1>
          <div style={{ background: theme.cardBg, borderRadius: '14px', padding: '24px', boxShadow: '0 8px 24px rgba(0,0,0,0.08)', marginBottom: '20px' }}>
            <div style={{ display: 'flex', gap: '16px', marginBottom: '20px', flexWrap: 'wrap' }}>
              <div style={{ flex: 1, minWidth: '140px', textAlign: 'center', background: darkMode ? '#0f2a25' : '#e9fdf3', borderRadius: '10px', padding: '14px' }}>
                <div style={{ fontSize: '22px', fontWeight: 800, color: '#02c39a' }}>{historyList.length}</div>
                <div style={{ fontSize: '11px', color: theme.muted }}>{L.reportsCount}</div>
              </div>
              <div style={{ flex: 1, minWidth: '140px', textAlign: 'center', background: darkMode ? '#0f2a25' : '#e9fdf3', borderRadius: '10px', padding: '14px' }}>
                <div style={{ fontSize: '15px', fontWeight: 800, color: '#02c39a' }}>{memberSince || '—'}</div>
                <div style={{ fontSize: '11px', color: theme.muted }}>{L.memberSince}</div>
              </div>
            </div>
            <label style={{ fontWeight: 'bold', color: theme.text }}>Name:</label>
            <input type="text" value={loginData.name} onChange={(e) => setLoginData({ ...loginData, name: e.target.value })} style={{ width: '100%', padding: '10px', marginBottom: '14px', borderRadius: '8px', border: '1px solid #ccc', marginTop: '6px' }} />
            <label style={{ fontWeight: 'bold', color: theme.text }}>Email:</label>
            <input type="email" value={loginData.email} disabled style={{ width: '100%', padding: '10px', marginBottom: '14px', borderRadius: '8px', border: '1px solid #ccc', marginTop: '6px', opacity: 0.7 }} />
            <label style={{ fontWeight: 'bold', color: theme.text }}>{L.defaultSkillsLabel}</label>
            <input type="text" value={defaultSkills} onChange={(e) => setDefaultSkills(e.target.value)} placeholder="e.g. React, Python, SQL" style={{ width: '100%', padding: '10px', marginBottom: '18px', borderRadius: '8px', border: '1px solid #ccc', marginTop: '6px' }} />
            <button onClick={saveProfile} style={{ width: '100%', background: 'linear-gradient(90deg, #028090, #02c39a)', color: '#fff', border: 'none', padding: '13px', borderRadius: '8px', fontWeight: 'bold', cursor: 'pointer' }}>{L.saveProfile}</button>
          </div>
        </div>
      )}
      ...
      <div className="no-print">
        <button onClick={() => setChatOpen(!chatOpen)} style={{ position: 'fixed', bottom: '20px', right: '20px', width: '56px', height: '56px', borderRadius: '50%', background: 'linear-gradient(135deg, #028090, #02c39a)', color: '#fff', border: 'none', fontSize: '22px', cursor: 'pointer', boxShadow: '0 6px 18px rgba(0,0,0,0.25)', zIndex: 150 }}>{chatOpen ? 'X' : '💬'}</button>
        {chatOpen && (
          <div className="chat-bubble-in" style={{ position: 'fixed', bottom: '86px', right: '20px', width: '300px', maxWidth: '90vw', height: '380px', background: theme.cardBg, borderRadius: '14px', boxShadow: '0 10px 30px rgba(0,0,0,0.25)', display: 'flex', flexDirection: 'column', overflow: 'hidden', zIndex: 150 }}>
            <div style={{ background: 'linear-gradient(90deg, #028090, #02c39a)', color: '#fff', padding: '12px 16px', fontWeight: 'bold', fontSize: '14px' }}>🤖 CareerTrust Assistant</div>
            <div style={{ flex: 1, overflowY: 'auto', padding: '12px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {chatMessages.map((m, i) => (<div key={i} style={{ alignSelf: m.sender === 'user' ? 'flex-end' : 'flex-start', background: m.sender === 'user' ? '#02c39a' : (darkMode ? '#0f2a25' : '#f0f0f0'), color: m.sender === 'user' ? '#fff' : theme.text, padding: '8px 12px', borderRadius: '12px', maxWidth: '85%', fontSize: '12.5px' }}>{m.text}</div>))}
              {botTyping && <div style={{ alignSelf: 'flex-start', background: darkMode ? '#0f2a25' : '#f0f0f0', padding: '10px 14px', borderRadius: '12px' }}><span className="typing-dot"></span><span className="typing-dot"></span><span className="typing-dot"></span></div>}
            </div>
            <div style={{ display: 'flex', borderTop: `1px solid ${theme.border}`, padding: '8px' }}>
              <input type="text" value={chatInput} onChange={(e) => setChatInput(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && handleChatSend()} placeholder="Ask about risk score, OTP, scams..." style={{ flex: 1, border: 'none', outline: 'none', padding: '8px', fontSize: '12.5px', background: 'transparent', color: theme.text }} />
